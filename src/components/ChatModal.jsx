...
const ChatModal = ({ userId, userName, userEmail, onClose }) => {
  ...
  const refreshMessages = async () => {
    ...
    setMessages(msgs);
    console.log("Manual refresh loaded", msgs.length, "messages");
  };
      ...
      <div className="bg-[#111] border border-white/10 rounded-2xl w-full max-w-md flex flex-col h-[600px]">
        ...
        <div className="flex justify-between items-center p-4 border-b border-white/10">
          ...
          <div className="flex gap-2">
            <button onClick={refreshMessages} className="text-white/40 hover:text-white text-xl" title="Refresh messages">
              ↻
            </button>
