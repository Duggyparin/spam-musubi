...
export default function Login() {
  ...
  // Google Sign-In (uses redirect – best for mobile)
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // The redirect will take the user to Google, then back to your app.
      // The result is handled in App.jsx (getRedirectResult)
    } catch (err) {
